...
Parts of this repository, particularly in original_models/ and modified_models/, include code licensed under the [GNU Affero General Public License v3 (AGPLv3)]. See AGPL_LICENSE for full terms. All original code developed for this evaluation is licensed under the MIT License.
